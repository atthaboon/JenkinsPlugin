 ...
 * @author u8018728
 */
public class SelectTestTrendChart extends DashboardPortlet {
   ...
   public SelectTestTrendChart(String name, int graphWidth, int graphHeight,
           String display, int dateRange, int dateShift, ArrayList<Checkbox> jobList) {
      super(name);
   ...
   public class DescriptorImpl extends Descriptor<DashboardPortlet> {
      ...
      public String getDisplayName() {
         return "Select Test Trend Chart";
      }
